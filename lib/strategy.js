...
Strategy.prototype.userProfile = function (accessToken, done) {
  ...
  this._oauth2._request('POST', 'https://apis.krp.toastoven.net/payco/friends/getProfileBasicByFriendsToken.json', headers, data, accessToken, function (err, body, res) {
    if (err) {
    ...
    try {
      ...
      profile.displayName = profileBasic.name
